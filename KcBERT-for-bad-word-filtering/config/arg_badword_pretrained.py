...
class Arg:
    ...
    pretrained_model: str = 'hanseokhyeon/bert-badword'  # Transformers PLM name
    pretrained_tokenizer: str = 'hanseokhyeon/tokenizer-badword'  # Optional, Transformers Tokenizer Name. Overrides `pretrained_model`
