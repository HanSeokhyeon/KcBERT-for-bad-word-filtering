...
class Arg:
    ...
    pretrained_model: str = 'hanseokhyeon/bert-badword-puri'  # Transformers PLM name
    pretrained_tokenizer: str = 'hanseokhyeon/tokenizer-badword-puri'  # Optional, Transformers Tokenizer Name. Overrides `pretrained_model`
