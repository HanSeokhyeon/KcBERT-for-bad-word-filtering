...
class Arg:
    ...
    pretrained_model: str = 'hanseokhyeon/bert-badword-puri-000'  # Transformers PLM name
    pretrained_tokenizer: str = 'hanseokhyeon/tokenizer-badword-puri-000'  # Optional, Transformers Tokenizer Name. Overrides `pretrained_model`
