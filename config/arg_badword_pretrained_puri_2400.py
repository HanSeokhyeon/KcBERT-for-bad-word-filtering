...
class Arg:
    ...
    pretrained_model: str = 'hanseokhyeon/bert-badword-puri-2400'  # Transformers PLM name
    pretrained_tokenizer: str = 'hanseokhyeon/tokenizer-badword-puri-2400'  # Optional, Transformers Tokenizer Name. Overrides `pretrained_model`
