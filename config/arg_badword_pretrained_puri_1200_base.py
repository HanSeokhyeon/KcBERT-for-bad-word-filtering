...
class Arg:
    ...
    pretrained_model: str = 'hanseokhyeon/bert-badword-puri-1200-base'  # Transformers PLM name
    pretrained_tokenizer: str = 'hanseokhyeon/tokenizer-badword-puri-1200-base'  # Optional, Transformers Tokenizer Name. Overrides `pretrained_model`
    ...
    val_data_path: str = "./badword/ratings_labeled_test.csv"  # Validation Dataset file
